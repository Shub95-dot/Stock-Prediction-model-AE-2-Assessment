...
if F2_OLD in src:
    ...
    warnings.append("Fix 2: pattern not matched. Apply manually to LightGBMMetaLearner.fit().")
...
if F3_OLD in src:
    ...
    warnings.append("Fix 3: pattern not matched. Apply manually to BarometerSystem.fit().")
...
if F4_OLD in src:
    ...
    warnings.append("Fix 4: pattern not matched. Apply manually to WalkForwardEvaluator.evaluate().")
